        ...
        <main className={context.mainClass}>
            ...
            <div className='flex flex-col gap-4 lg:flex-row w-full max-w-[1500px]'>
                ...
                <div className='mt-4 flex flex-col items-center w-full'>
                    <div className={' gap-4 ' + (preferences.list ? 'center items-center ' : 'grid gap-6 grid-cols-1 sm:grid-cols-2 min-[932px]:grid-cols-3 2xl:grid-cols-4')}>
                        {listPages.map(art =>
                            <Card
                                key={art.name + art.key}
                                shadow="sm"
                                className='xs:max-w-[300px] justify-between data-[display=list]:sm:max-w-[800px] data-[display=list]:sm:flex-row data-[display=list]:xs:mx-2 max-xs:rounded-none shadow-lg hover:shadow-success'
