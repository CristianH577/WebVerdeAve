...
import addLangText from '../../../../lang/Designs/Maps/components/LeafletMap.json'
...
function LeafletMap() {
    ...
    const contextImgs = require.context('../../../../assets/imgs/designs/maps/', true)
    ...
    return (
        <section className='w-full center items-center'>
            ...
            <div className='w-full h-[500px] my-6 min-[360px]:rounded-lg shadow-medium'>
                <MapContainer
                    center={center}
                    zoom={14}
