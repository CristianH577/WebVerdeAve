...
import addLangText from '../../lang/diseños/galerias.json'
import { useOutletContext } from 'react-router-dom';

import { Button } from "@nextui-org/react";
import { Select, SelectItem } from "@nextui-org/react";

import MakeGalery from './components/make_galery.js'
...
function Galerias() {
    ...
    const [data] = useState({
        ...
        articles: Array.from(Array(30), (x, i) =>
            x = {
                key: i + 1,
                // title: langText.card.title + (i + 1),
                // subtitle: langText.card.subtitle,
    ...
    return (
        <main className={context.mainClass}>
            ...
            <div className={context.titleClass}>{langText.galerias}</div>
            ...
            {!loadingContent && showContent && content}
