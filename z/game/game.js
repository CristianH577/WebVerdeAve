...
function Game() {
    ...
    const icons = {
        ...
        fight:{
            mobs: {
                goblin: <GiGoblinHead className='w-full h-full' />,
                orc: <GiOrcHead className='w-full h-full'  />,
            },
        }
    }
                ...
                if (y in char.map[x]) {
                    ...
                    if (bool) {
                        if (char.map[x][y].kind === "empty") {
                            bool = true
                            console.log(char.map[x][y].layer)
                    ...
                    >
                        <ModalContent className='font-bold'>
                            ...
                            <ModalFooter className='bg-game_s2 text-game_s1 flex-col text-center'>
                                ...
                                <Button onPress={() => console.log(char)}>
                                    char
                                </Button>
                            </ModalFooter>
                        </ModalContent>
